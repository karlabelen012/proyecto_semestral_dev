...
public class VentaController {
    ...
    @PostMapping
    public ResponseEntity<Venta> crearVenta(@Valid @RequestBody @NonNull Venta venta){
    ...
    public ResponseEntity<Venta> actualizarVenta(@Valid @PathVariable @NonNull Long idVenta, @RequestBody @NonNull Venta venta) throws VentaNotFoundException {
    ...
    public ResponseEntity<Venta> obtenerVenta(@PathVariable @NonNull Long idVenta) throws VentaNotFoundException {
    ...
    public ResponseEntity<Void> eliminarVenta(@PathVariable @NonNull Long idVenta) throws VentaNotFoundException {
